...
add_action( 'tgmpa_register', 'tnea_register_required_plugins' );
/**
 * Register the required plugins for this theme.
 */
function tnea_register_required_plugins() {
	$plugins = array(
		array(
			'name' 		=> 'Contact Form 7',
			'slug' 		=> 'contact-form-7',
		...
		array(
			...
			'slug' 		=> 'responsive-slider',
			'required' 	=> false,
		),
		array(
			'name' 		=> 'Simply Instagram',
			'slug' 		=> 'simply-instagram',
			'required' 	=> false,
		),
		array(
			'name' 		=> 'Sponsors Slideshow Widget',
			'slug' 		=> 'sponsors-slideshow-widget',
			'required' 	=> false,
		),
		array(
...
function skeleton_setup() {
	...
	register_nav_menus( array(
		...
		'footer' => __( 'Footer Navigation', 'skeleton' ),
	));
